        ...
        <section className="w-full h-[90vh] flex items-center justify-center border-b border-zinc-900 backgroundGrandientHero">
            <div className="max-w-screen-xl flex flex-col lg:flex-row">
                <div className="w-full flex flex-col justify-start">
                    ...
                    <p className="text-xl lg:text-3xl font-oswald tracking-wide">Advogada especializada em Direito Tributário no escritório <span className="text-blue-700 font-bold lg:text-xl hover:underline"><a href="https://advocaciajf.com/" target="_blank">JF Advocacia tributária</a></span>.</p>
                </div>
