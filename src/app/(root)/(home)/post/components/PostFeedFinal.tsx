...
import ImagemIlustrativa from '../../../../../../public/Imagem do WhatsApp de 2024-06-09 à(s) 16.58.57_13f4e412.jpg'
        ...
        <div className="flex flex-col items-center gap-4 mb-10 max-w-md m-auto">
            <section className="flex flex-col justify-between relative mt-10 w-[446px] h-[446px] p-10 bg-[#0f39f616]">
                ...
                <footer className="w-full">
                    ...
                    {/* <ul className="flex items-center justify-center gap-4 text-[#0F39F6]">
                        <li className="flex items-center gap-1">
                            <Heart />
                            <p>Curte</p>
                        </li>
